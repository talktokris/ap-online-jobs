                ...
                <div class="card-body">
                    <div class="row verticle-center">
                        ...
                        <div class="col-md-2 mb-2 text-center" style="border: 1px solid #e6edee; height: 220px; padding-top: 10px;">
                            ...
                            <img class="img-thumbnail" src="{{$user->profile_image != '' ? asset('storage/resume/'.$user->profile_image) : asset('images/avatar.jpg')}}" style="height: 130px; width: 130px; border-radius: 50%; margin-bottom: 10px;" alt="{{$user->name ?? ''}}">
                            <br>
                        ...
                        <div class="col-md-4 mb-2" style="border: 1px solid #e6edee; border-left: none; height: 220px; padding-top: 10px;">
                            <table class="table table-sm table-borderless">
                                <tr>
                                    ...
                                    <th width="5%">:</th>
                                    <td width="60%">{{$user->job_seeker_job_category_data->name ?? ''}}</td>
                                </tr>
                                <tr>
                                    <th></th>
                                    <th width="35%">Name</th>
                                    <th width="5%">:</th>
                                    <td width="60%">{{$user->full_name ?? ''}}</td>
                                </tr>
                                <tr>
                                    <th></th>
                                    <th width="35%">Age</th>
                                    <th width="5%">:</th>
                                    <td width="60%">{{$user->age() ?? ''}}</td>
                                </tr>
                                <tr>
                                    <th></th>
                                    <th width="35%">City</th>
                                    <th width="5%">:</th>
                                    <td width="60%">{{$user->city->name ?? ''}}</td>
                                </tr>
                                <tr>
                                    <th></th>
                                    <th width="35%">Salary</th>
                                    <th width="5%">:</th>
                                    <td width="60%">{{$user->expected_salary ?? ''}}</td>
                                </tr>
                            </table>
                        </div>
                        @endforeach
