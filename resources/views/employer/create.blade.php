            ...
            <form method="POST" action="{{ route('register') }}" aria-label="{{ __('Register') }}" enctype="multipart/form-data" id="my-form">
                ...
                <div class=" form-group row" style="margin-left: 150px;">
                    <div class="col-sm-6">
                        <div class="checkbox checkbox-info checkbox-circle">
                            <input id="looking_for_job_seeker" name="employer_type" value="1" class="styled" type="radio" checked onClick="showHide()" required>
                            <label for="checkbox8">
                            Looking For Professional/Job Seeker
                            </label>
                        </div>
                ...
                <div class="form-group row">
                    <div class="col-sm-6" id="company_name">
                        ...
                        <input type="text" name="company_name"  class="form-control" id="com_name" value="{{ old('company_name') }}" required placeholder="Company Name">
                    ...
                    <div class="col-sm-3" id="registration_number">
                        ...
                        <input type="text" name="roc" class="form-control" id="com_registration" value="{{ old('roc') }}" placeholder="Registration Number">
                            @if ($errors->has('roc'))
                    ...
                    <div class="col-sm-3" id="telephone_number">
                        ...
                        <input type="text" name="company_phone" class="form-control" id="com_number" value="{{ old('company_phone') }}" required placeholder="Telephone Number">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    <div class="col-sm-6" id="com_country">
                        ...
                        <select name="company_country"  value="{{ old('company_country') }}" id="company_country" required class="form-control" >
                    ...
                    <div class="col-sm-3" id="com_website">
                        ...
                        <input type="text" name="website" class="form-control" id="inputWebsite" placeholder="Website" value="{{ old('website') }}">
                    </div>
                </div>
                ...
                <div class="form-group row" > 
                        ...
                        <select name="company_state" id="company_state" required class="form-control">
                            ...
                            @if(old('company_state'))
                                @foreach ($states as $states)
                                    <option value="{{$states->id}}" {{$states->id == old('company_state') ? 'selected':''}}>{{$states->name}}</option>
                                @endforeach
                            @endif
                        </select>
                    </div>
                    <div class="col-sm-3" id="com_city">
                        ...
                        <select name="company_city" value="{{ old('company_city') }}" id="company_city" required class="form-control">
                            <option value="" disable="true" selected="true">-------  Select City -------</option> 
                            @if(old('company_city'))
                                @foreach ($cities as $cities)
                                    <option value="{{$cities->id}}" {{$cities->id == old('company_city') ? 'selected':''}}>{{$cities->name}}</option>
                                @endforeach
                            @endif
                        </select>
                    </div>
                    <div class="col-sm-6" id="com_address">
                        ...
                        <input type="text" name="company_address" value="{{ old('company_address') }}" class="form-control"  placeholder="Company Address">
                    </div>
                ...
                <div class="form-group row">
                    <div class="col-sm-6">
                            ...
                            <input type="text" class="form-control" id="inputFirstname" name="name" value="{{ old('name') }}" required placeholder="Contact Person Name">
                        </div>
                        <div class="col-sm-3" style="display:none;" id="per_email">
                            ...
                            <input type="text" name="contact_email" value="{{ old('contact_email') }}" class="form-control" id="cont_email" placeholder="Contact Person Email">
                        </div>
                        <div class="col-sm-3">
                            <label for="phone">Contact Number</label>
                            <input type="text" name="phone" value="{{ old('phone') }}" class="form-control"  placeholder="Contact Person Number">
                        </div>
                    </div>
                <div class="form-group row" >
                    ...
                    <div class="col-sm-3" id="per_state" style="display:none;">
                        ...
                        <select name="state" class="form-control" id="person_state">
                            ...
                            @if(old('state'))
                                @foreach ($states as $states)
                                    <option value="{{$states->id}}" {{$states->id == old('state') ? 'selected':''}}>{{$states->name}}</option>
                                @endforeach
                            @endif
                        </select>
                    </div>
                    <div class="col-sm-3" id="per_city" style="display:none;">
                        ...
                        <select name="city" class="form-control" id="person_city" value="{{ old('city') }}">
                            <option value="">-------  Select City -------</option>
                            @if(old('city'))
                                @foreach ($cities as $cities)
                                    <option value="{{$cities->id}}" {{$cities->id == old('city') ? 'selected':''}}>{{$cities->name}}</option>
                                @endforeach
                            @endif
                        </select>
                    </div>
