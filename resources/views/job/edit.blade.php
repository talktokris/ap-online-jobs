                ...
                <div class="card-body">
                            ...
                            <div class="col-sm-8">
                                ...
                                <select name="positions_name" id="positions_name" class="form-control{{ $errors->has('positions_name') ? ' is-invalid' : '' }}" required>
                                    ...
                                    @foreach ($PositionNames as $PositionName)
                                        <option value="{{$PositionName->id}}" {{$PositionName->id == $job->positions_name ? 'selected' : ''}}>{{$PositionName->name}}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="tab">
                        <div class="form-group dis-cls">
                            ...
                            <div class="col-sm-8">
                                <input id="posted_by" type="text" class="form-control{{ $errors->has('posted_by') ? ' is-invalid' : '' }}" name="posted_by" value="{{ $job->posted_by }}">
