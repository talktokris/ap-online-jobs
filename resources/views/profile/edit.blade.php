                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('profile.update', $user->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="company_country" id="company_country" required class="form-control" >
                                        <option value="{{$profile->country}}" disable="true" selected="true">{{$profile->country_data->name ?? 'N/A'}}</option>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="company_state" id="company_state" required class="form-control">
                                        <option value="{{$profile->state}}" disable="true" selected="true">{{$profile->state_data->name ?? 'N/A'}}</option>
                                    </select>
                                    @if ($errors->has('state'))
                                        <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="company_city" id="company_city" required class="form-control">
                                        <option value="{{$profile->city}}" disable="true" selected="true">{{$profile->city_data->name ?? 'N/A'}}</option> 
                                    </select>
                                    @if ($errors->has('city'))
                                        <span class="invalid-feedback" role="alert">
                            ...
                            <!-- do and don't added for edit for maid only by milesh 3/26/2020 -->
                            @if($profile->user->hasRole('maid'))
                                <div class="col-md-12 pt-5 page-section" id="do_dont">
                                    <div class="row">
                                        ...
                                        @if($do_dont_set)
                                        @foreach($skills as $skill)
                                            @if ( $skill->for == $skill_for && $skill->type == 'Do & Do not')
                                                <div class="col-md-6">
                                                    <div class="form-group" style="display:flex;">
                                                        @php
